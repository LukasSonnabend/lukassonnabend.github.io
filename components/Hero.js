    ...
    <div className="row py-8">
      <div className="col-lg-4 d-flex justify-content-center">
        <div className="text-center">
          <img className="img max-w-full max-h-48 md:max-h-72 h-auto lg:h-64 rounded-full mb-1 mx-auto" src="me.jpg"></img>
            ...
            <div className="row">
              ...
              <div className="col-md-8">
                ...
                <ul className="p-0">
                  ...
                  <li className="d-flex"><FaUniversity className="d-inline col-1"/> <span className="col-11">BA. Marketing & Communi&#173;cations Management 2019</span></li>
                </ul>
              </div>
            </div>
          </div>
