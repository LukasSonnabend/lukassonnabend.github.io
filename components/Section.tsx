...
//"col-span-12 md:col-span-8 xl:col-span-6 right_side">
  return (
    <div id={props.id} className={props.className + ' text-slate-900 dark:text-white'}>
      <div className="dark:bg-slate-900 grid gap-4 grid-cols-12 justify-center p-2 md:pr-4 lg:p-4">
        ...
        <div className="col-span-6 grid grid-flow-row auto-rows-[1fr] gap-y-4">
          {props.children}
        </div>
      </div>
    </div>
